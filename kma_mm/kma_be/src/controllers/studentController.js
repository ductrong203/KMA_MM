...
class SinhVienController {
  ...
  static async update(req, res) {
    try {
      ...
      const oldData = {
        ...
        "to_hop_xet_tuyen": oldDataRaw.to_hop_xet_tuyen,
        "diem_trung_tuyen": oldDataRaw.diem_trung_tuyen,
        "quyet_dinh_trung_tuyen": oldDataRaw.quyet_dinh_trung_tuyen,
        "ngay_ban_hanh_qd_trung_tuyen": oldDataRaw.ngay_ban_hanh_qd_trung_tuyen,
      ...
      try {
        ...
        if (updatedSinhVien) {
          ...
          const newData = {
            ...
            "to_hop_xet_tuyen": newDataRaw.to_hop_xet_tuyen,
            "diem_trung_tuyen": newDataRaw.diem_trung_tuyen,
            "quyet_dinh_trung_tuyen": newDataRaw.quyet_dinh_trung_tuyen,
            "ngay_ban_hanh_qd_trung_tuyen": newDataRaw.ngay_ban_hanh_qd_trung_tuyen,
  ...
  static async exportPreview(req, res) {
    try {
      const result = await SinhVienService.getDanhSachSinhVienPreview(req.body);
      res.status(200).json({ success: true, data: result });
    } catch (error) {
