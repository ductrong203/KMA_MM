...
function initModels(sequelize) {
  ...
  ke_hoach_mon_hoc.belongsTo(danh_muc_dao_tao, {
    as: "danh_muc",
    foreignKey: "danh_muc_id",
  });
  danh_muc_dao_tao.hasMany(ke_hoach_mon_hoc, {
    as: "ke_hoach_mon_hocs",
    foreignKey: "danh_muc_id",
  });
  khoa_dao_tao.belongsTo(danh_muc_dao_tao, {
    as: "he_dao_tao",
    foreignKey: "he_dao_tao_id",
  });
  danh_muc_dao_tao.hasMany(khoa_dao_tao, {
    as: "khoa_dao_taos",
    foreignKey: "he_dao_tao_id",
  });
  khen_thuong_ky_luat.belongsTo(danh_muc_khen_ky_luat, {
    as: "danh_muc",
    foreignKey: "danh_muc_id",
  });
  danh_muc_khen_ky_luat.hasMany(khen_thuong_ky_luat, {
    as: "khen_thuong_ky_luats",
    foreignKey: "danh_muc_id",
  });
  sinh_vien.belongsTo(doi_tuong_quan_ly, {
    as: "doi_tuong",
    foreignKey: "doi_tuong_id",
  });
  doi_tuong_quan_ly.hasMany(sinh_vien, {
    as: "sinh_viens",
    foreignKey: "doi_tuong_id",
  });
  thoi_khoa_bieu.belongsTo(giang_vien, {
    as: "giang_vien",
    foreignKey: "giang_vien_id",
  });
  giang_vien.hasMany(thoi_khoa_bieu, {
    as: "thoi_khoa_bieus",
    foreignKey: "giang_vien_id",
  });
  lop.belongsTo(khoa_dao_tao, {
    as: "khoa_dao_tao",
  ...
  ke_hoach_mon_hoc.belongsTo(mon_hoc, {
    as: "mon_hoc",
    foreignKey: "mon_hoc_id",
  });
  mon_hoc.hasMany(ke_hoach_mon_hoc, {
    as: "ke_hoach_mon_hocs",
    foreignKey: "mon_hoc_id",
  });
  thoi_khoa_bieu.belongsTo(mon_hoc, {
    as: "mon_hoc",
    foreignKey: "mon_hoc_id",
  });
  mon_hoc.hasMany(thoi_khoa_bieu, {
    as: "thoi_khoa_bieus",
    foreignKey: "mon_hoc_id",
  });
  giang_vien.belongsTo(phong_ban, {
    as: "phong_ban",
    foreignKey: "phong_ban_id",
  });
  phong_ban.hasMany(giang_vien, {
    as: "giang_viens",
    foreignKey: "phong_ban_id",
  });
  diem.belongsTo(sinh_vien, { as: "sinh_vien", foreignKey: "sinh_vien_id" });
  sinh_vien.hasMany(diem, { as: "diems", foreignKey: "sinh_vien_id" });
  khen_thuong_ky_luat.belongsTo(sinh_vien, {
    as: "sinh_vien",
    foreignKey: "sinh_vien_id",
  });
  sinh_vien.hasMany(khen_thuong_ky_luat, {
    as: "khen_thuong_ky_luats",
    foreignKey: "sinh_vien_id",
  });
  thong_tin_quan_nhan.belongsTo(sinh_vien, {
    as: "sinh_vien",
    foreignKey: "sinh_vien_id",
  });
  sinh_vien.hasMany(thong_tin_quan_nhan, {
