...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    ...
    try {
      ...
      console.log('Ignore changeColumn error:', error.message);
    }
    ...
    try {
      ...
      console.log('Ignore addConstraint error:', error.message);
    }
  },
  ...
  down: async (queryInterface, Sequelize) => {
    try {
      ...
      console.log('Ignore removeConstraint error:', error.message);
    }
