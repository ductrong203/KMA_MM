...
const ThoiKhoaBieu = () => {
    ...
    const [kyHocOptionsForm, setKyHocOptionsForm] = useState([]); // Kỳ học cho form
    const [kyHocOptionsFilter, setKyHocOptionsFilter] = useState([]); // Kỳ học cho bộ lọc
    ...
    const [monHocFilterList, setMonHocFilterList] = useState([]);
    ...
    const fetchMonHocByHeDaoTao = async (heDaoTaoId) => {
        try {
            ...
            setMonHocFilterList(data.data);
            setMonHocList(data.data);
        } catch (error) {
                            ...
                            <Grid item xs={12} textAlign="center">
                                <Button
                                    ...
                                    sx={{
                                        ...
                                        "&:hover": {
                                            backgroundColor: kyHocFilter || lopIdFilter || heDaoTaoFilter || khoaDaoTaoFilter || monHocIdFilter ? "#b71c1c" : "#115293"
                                        }
                                    }}
                                    onClick={() => {
