...
//   const [maxSemesters, setMaxSemesters] = useState(0);
//   const [subjects, setSubjects] = useState([]); // Toàn bộ môn học cho hiển thị
//   const [subjectsByCurriculum, setSubjectsByCurriculum] = useState([]); // Môn học theo hệ đào tạo cho form
//   const [openForm, setOpenForm] = useState(false);
//   const [formData, setFormData] = useState({
//     khoa_dao_tao_id: '',
//     mon_hoc_id: '',
...
//   // Lấy toàn bộ môn học cho hiển thị
//   useEffect(() => {
//     axios.get('http://localhost:8000/mon-hoc')
//       .then(response => setSubjects(Array.isArray(response.data) ? response.data : []))
//       .catch(error => console.error('Lỗi khi lấy toàn bộ môn học:', error));
//   }, []);

//   // Lấy môn học theo hệ đào tạo cho form
//   useEffect(() => {
//     if (selectedCurriculum) {
//       axios.get(`http://localhost:8000/mon-hoc/getByHeDaoTaoId/${selectedCurriculum}`)
//         .then(response => {
//           const subjectsData = response.data.data && Array.isArray(response.data.data)
//             ? response.data.data
//             : [];
//           setSubjectsByCurriculum(subjectsData);
//         })
//         .catch(error => console.error('Lỗi khi lấy môn học theo hệ đào tạo:', error));
//     } else {
