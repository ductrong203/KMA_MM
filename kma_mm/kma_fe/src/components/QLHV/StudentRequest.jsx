...
const StudentRequests = () => {
    const [requests, setRequests] = useState([
        { id: 1, student: "Nguyễn Văn A", type: "Xin nghỉ phép", status: "Chờ duyệt" },
        { id: 2, student: "Trần Thị B", type: "Xin nghỉ phép", status: "Chờ duyệt" },
    ...
    return (
        <Container maxWidth="md">
            ...
            {/* Bộ lọc đơn từ */}
            <Select value={filter} onChange={(e) => setFilter(e.target.value)} style={{ marginBottom: 20 }}>
                                    ...
                                    {request.status === "Chờ duyệt" && (
                                        <>
                                            <Button
                                                variant="contained"
                                                color="success"
                                                onClick={() => handleUpdateStatus(request.id, "Đã duyệt")}
                                            ...
                                            <Button
                                                variant="contained"
                                                color="error"
                                                onClick={() => handleUpdateStatus(request.id, "Bị từ chối")}
                                            >
                                                Từ chối
                                            </Button>
                                        </>
